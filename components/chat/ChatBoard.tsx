...
export default function ChatBoard({ messages, agents }: { messages: ChatMessageView[]; agents: AgentView[] }) {
  return (
    <div className="chat-board" style={css("padding:clamp(16px,4vw,36px) clamp(16px,5vw,40px);display:flex;gap:24px;height:calc(100dvh - 64px)")}>
      ...
      <div className="chat-mentions" style={css("width:220px;flex:none;display:flex;flex-direction:column;gap:14px")}>
