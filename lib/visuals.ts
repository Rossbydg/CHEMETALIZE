...
// Maps a capability to the icon glyph that best represents it (shared by the dashboard orbit and agent avatars).
export const CAPABILITY_ICON_TYPE: Record<string, string> = {
  scrape: "research",
  research: "research",
  outreach: "email",
  "follow-up": "email",
